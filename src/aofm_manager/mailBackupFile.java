 ...
 * @author REUBEN
 */
public class mailBackupFile {
    
    public mailBackupFile( String to) {
        System.out.println("in mail handler");
        //Attachments array
        String attachments[] = {"c:\\Flock_Management_System\\backup.sql"}; 
...
// Now set the actual message 
            String messageBody = "Hello,\nPlease find the attached file of your database backup. This file would be used in case of data loss .\nNB: This email is automated please do not reply as you may not get any feedback.\n\nThank You.\nThe Flock Team";
...
// Send message 
            ...
            //JOptionPane.showMessageDialog(null,"Chart Delivered Successfully!", "Online Backup Message", 1); 
        } 
