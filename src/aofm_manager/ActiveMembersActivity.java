 ...
 * @author REUBEN
 */
public class ActiveMembersActivity extends javax.swing.JFrame {
    final static int NO_OF_COLUMNS = 9;
    ArrayList<AllMembersDetails> allUserDetails = new ArrayList<>();
    static String editMemberId = "";
    /**
     * Creates new form ActiveMembersActivity
     */
    public ActiveMembersActivity() {
        initComponents();
        super.setTitle("AOFM MANAGER[Active Members]");
    ...
    private void allDetailsQuery(){
        ...
        try{
            ...
            if(rset.getFetchSize()==0){
                //JOptionPane.showMessageDialog(this,"No active member found","Search Results",2);
            }
    ...
    private void searchBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchBtnActionPerformed
        ...
        if(searchFld.getText().length()>0){
            ...
            try{
                ...
                String query = "select * from register where "+colName+" like \'%"+searchVal+"%\' and status ='Active'";
                if(colName.equals("id")){
                    query = "select * from register where "+colName+" =\'"+searchVal+"\' and status ='Active'";
                }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ActiveMembersActivity.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ActiveMembersActivity().setVisible(true);
            }
        });
    }
