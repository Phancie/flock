...
public class MainActivity extends javax.swing.JFrame {
        ...
        if(!AllMembersActivity.editMemberId.isEmpty()){
            ...
            try{
                ...
                while(rset.next()){
                    ...
                    mNameFld.setText(mname);
                    lNameFld.setText(lname);
                    ((JTextField)dobChooser.getDateEditor().getUiComponent()).setText(dob);
    ...
    private void initComponents() {
        ...
        areaFld = new javax.swing.JTextField();
        ...
        mNameFld.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                mNameFldActionPerformed(evt);
            }
        });
        ...
        headerLbl.setFont(new java.awt.Font("Garamond", 1, 18)); // NOI18N
        headerLbl.setText("Register New Member");

        statusLbl.setText("Status*");

        statusCombo.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "", "Active", "Passive", "Outreach" }));
        ...
        imageLbl.setIcon(new javax.swing.ImageIcon(getClass().getResource("/aofm_manager/defaultImg.png"))); // NOI18N
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                        ...
                        .addComponent(mNameLbl, javax.swing.GroupLayout.DEFAULT_SIZE, 84, Short.MAX_VALUE))
                    .addComponent(lNameLbl, javax.swing.GroupLayout.PREFERRED_SIZE, 75, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(dobLbl, javax.swing.GroupLayout.PREFERRED_SIZE, 92, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(phoneLbl, javax.swing.GroupLayout.PREFERRED_SIZE, 84, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(statusLbl, javax.swing.GroupLayout.PREFERRED_SIZE, 48, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(areaLbl, javax.swing.GroupLayout.PREFERRED_SIZE, 34, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        .addGap(37, 37, 37)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                .addComponent(areaFld)
                                .addComponent(lNameFld)
                                .addComponent(dobChooser, javax.swing.GroupLayout.DEFAULT_SIZE, 203, Short.MAX_VALUE)
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addComponent(headerLbl, javax.swing.GroupLayout.PREFERRED_SIZE, 224, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(95, 95, 95))
        );
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGap(20, 20, 20)
                .addComponent(headerLbl, javax.swing.GroupLayout.PREFERRED_SIZE, 26, javax.swing.GroupLayout.PREFERRED_SIZE)
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(fnameFld, javax.swing.GroupLayout.PREFERRED_SIZE, 29, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(35, 35, 35)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(mNameLbl)
                    .addComponent(mNameFld, javax.swing.GroupLayout.PREFERRED_SIZE, 28, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(27, 27, 27)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(lNameLbl)
                    .addComponent(lNameFld, javax.swing.GroupLayout.PREFERRED_SIZE, 28, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(22, 22, 22)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(dobLbl)
                    .addComponent(dobChooser, javax.swing.GroupLayout.PREFERRED_SIZE, 28, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(27, 27, 27)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(phoneLbl)
                    .addComponent(phoneFld, javax.swing.GroupLayout.PREFERRED_SIZE, 29, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(26, 26, 26)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(areaFld, javax.swing.GroupLayout.PREFERRED_SIZE, 28, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void mNameFldActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mNameFldActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_mNameFldActionPerformed
        ...
        {    File file = filechooser.getSelectedFile();
             ...
             if(!AllMembersActivity.editMemberId.isEmpty()){
                 try{
                        ...
                        String query = "update register set image= ? where id =?";
                        System.err.println(query);
                        PreparedStatement pstmt = con.prepareStatement(query);
                        pstmt.setBlob(1, is);
                        pstmt.setInt(2, Integer.parseInt(AllMembersActivity.editMemberId));
                        pstmt.executeUpdate();
                 }catch(Exception e){}
             }    
    ...
    private void registerBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_registerBtnActionPerformed
        ...
        if(fnameFld.equals("")||lNameFld.equals("") ||dobChooser.getDate()==null ||
                phoneFld.getText().equals("")||areaFld.getText().equals("") ){
            if(AllMembersActivity.editMemberId.isEmpty()){
                //FOR NEW REGISTRATION CHECK FOR AN IMAGE
                if(imgPath==null){
                    JOptionPane.showMessageDialog(this, "Please make sure to fill all required fields", "Registration Message", 0);
                }
            }
            return;
        }
        ...
        try{
            ...
            if(AllMembersActivity.editMemberId.isEmpty()){
                ...
                imgPath = null;
                    ...
                    PreparedStatement pstmt = con.prepareStatement("update register set fname =?,mname =?,lname =?,dob =?,phone =?,area =?,status =? where id =?");
                    pstmt.setString(1, fnameFld.getText());
                    pstmt.setString(2, mNameFld.getText());
                    pstmt.setString(3, lNameFld.getText());
                    pstmt.setString(4, ((JTextField)dobChooser.getDateEditor().getUiComponent()).getText());
    ...
    private void cancelBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cancelBtnActionPerformed
        // TODO add your handling code here:
        int dialogResult = JOptionPane.showConfirmDialog (null, "All data for this member would be lost.Would You Like to continue?","Warning",2);
